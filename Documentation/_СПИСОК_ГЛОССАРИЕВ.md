...
> Индекс глоссариев пайплайна локализации. Определения терминов — только в глоссариях; в остальных документах — ссылки ([ПРАВИЛА_ОБЩИЕ](../ПРАВИЛА_ОБЩИЕ.md)).
>
> Один файл глоссария на сущность: `Documentation/Glossary/<Entity>.md`.

## Глоссарий процесса локализации

- **ГЛОССАРИЙ_ЛОКАЛИЗАЦИИ** — [Glossary/ГЛОССАРИЙ_ЛОКАЛИЗАЦИИ.md](Glossary/ГЛОССАРИЙ_ЛОКАЛИЗАЦИИ.md) — термины пайплайна (базовый файл, ключ, статус, валидация и т.д.)
