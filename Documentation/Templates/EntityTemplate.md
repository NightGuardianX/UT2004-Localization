...
- After creating a new entity glossary file from this template, always add a linked entry for it to `Documentation/_СПИСОК_ГЛОССАРИЕВ.md` (see [Glossary Rules](../Glossary%20Rules.md)).
