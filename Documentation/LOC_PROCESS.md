...
| Step | Who | Action |
|------|-----|--------|
| 1 | Agent / you | **Sync and analyze incoming** — pull/merge `main`, analyze only what changed (diff). **Output:** [\_INCOMING_ANALYSIS.md](_INCOMING_ANALYSIS.md). See [STEP_SYNC_AND_ANALYZE_INCOMING](STEP_SYNC_AND_ANALYZE_INCOMING.md). |
| 2 | Agent / you | **Validate .rut vs glossaries** — use \_INCOMING_ANALYSIS.md; validate changed strings against entity glossaries; fill Current Russian when empty; sync [duplicated keys](DUPLICATED_KEYS.md). **Output:** [\_VALIDATION_REPORT.md](_VALIDATION_REPORT.md). See [STEP_VALIDATE_AND_UPDATE_GLOSSARY](STEP_VALIDATE_AND_UPDATE_GLOSSARY.md). |
...
1. Run [STEP_SYNC_AND_ANALYZE_INCOMING](STEP_SYNC_AND_ANALYZE_INCOMING.md) → produce \_INCOMING_ANALYSIS.md.
2. Run [STEP_VALIDATE_AND_UPDATE_GLOSSARY](STEP_VALIDATE_AND_UPDATE_GLOSSARY.md) → produce \_VALIDATION_REPORT.md.
...
| Step | Who | Action |
|------|-----|--------|
| 1 | Agent / you | **Sync and analyze incoming** — same as Process 1: merge, diff, **Output:** [\_INCOMING_ANALYSIS.md](_INCOMING_ANALYSIS.md). [STEP_SYNC_AND_ANALYZE_INCOMING](STEP_SYNC_AND_ANALYZE_INCOMING.md). |
| 2 | Agent / you | **Validate .rut vs glossaries** — compare changed translations with glossaries; fill Current Russian where empty; sync duplicated keys. **Output:** [\_VALIDATION_REPORT.md](_VALIDATION_REPORT.md). [STEP_VALIDATE_AND_UPDATE_GLOSSARY](STEP_VALIDATE_AND_UPDATE_GLOSSARY.md). |
...
1. Run [STEP_SYNC_AND_ANALYZE_INCOMING](STEP_SYNC_AND_ANALYZE_INCOMING.md) → \_INCOMING_ANALYSIS.md.
2. Run [STEP_VALIDATE_AND_UPDATE_GLOSSARY](STEP_VALIDATE_AND_UPDATE_GLOSSARY.md) → \_VALIDATION_REPORT.md.
...
| Purpose | Document |
|--------|----------|
| Sync and analyze diff | [STEP_SYNC_AND_ANALYZE_INCOMING](STEP_SYNC_AND_ANALYZE_INCOMING.md) → writes [\_INCOMING_ANALYSIS.md](_INCOMING_ANALYSIS.md) |
| Validate and glossary | [STEP_VALIDATE_AND_UPDATE_GLOSSARY](STEP_VALIDATE_AND_UPDATE_GLOSSARY.md) → writes [\_VALIDATION_REPORT.md](_VALIDATION_REPORT.md) |
