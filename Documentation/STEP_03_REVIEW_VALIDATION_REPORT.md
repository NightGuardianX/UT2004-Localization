...
| **For translator to fix → Language‑quality issues — typos and non‑Russian fragments** | Typos and non‑Russian fragments (e.g. leftover Spanish) in changed strings from the diff. These usually do **not** require Stage 1 decisions; they are listed directly as tasks for the translator. |
