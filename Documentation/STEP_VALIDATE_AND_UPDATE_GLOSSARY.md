...
- [STEP_SYNC_AND_ANALYZE_INCOMING](STEP_SYNC_AND_ANALYZE_INCOMING.md) — upstream step; produces [\_INCOMING_ANALYSIS.md](_INCOMING_ANALYSIS.md) (merge, list of changed .rut, keys and new Russian values).
