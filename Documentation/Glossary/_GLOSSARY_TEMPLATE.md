...
Otherwise list rules that override or extend the general [GLOSSARY_RULES](../GLOSSARY_RULES.md) for this entity.)*
...
- After creating a new entity glossary file from this template, always add a linked entry for it to [_GLOSSARIES_LIST](../_GLOSSARIES_LIST.md) (see [GLOSSARY_RULES](../GLOSSARY_RULES.md)).
