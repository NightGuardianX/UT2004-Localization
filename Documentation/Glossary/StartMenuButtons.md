## Entity Glossary Rules (StartMenuButtons)
...
- **Exclusions:** Submenu buttons (inside Instant Action, Settings, etc.) and mid‑game menu entries are not included here; they belong to other UI entities (Menus, Dialogs, etc.).
